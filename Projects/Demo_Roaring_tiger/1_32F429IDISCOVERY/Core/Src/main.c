...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
extern uint32_t bsp_lcd_get_fb_address(void);
extern void bsp_lcd_fill_fb(uint32_t rgb888, uint32_t x1, uint32_t x2,uint32_t y1,uint32_t y2);
extern void bsp_lcd_set_fb_background_color(uint32_t color_24bit);
#define FRAME_NO 50
/* USER CODE END 0 */
